...
<div class="section">
    ...
    <p>Simply enter the number of users you want to generate, with a maximum of 25. You can choose to add an address and/or a phone number by checking the boxes. To generate a new set of random users, please click the random user button above again. Have fun!</p><br>
    <div class="form">
    <form method="post">
