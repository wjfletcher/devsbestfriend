...
<div class="section">
    ...
    <p>Simply enter the number of paragraphs you want to generate, with a maximum of 25. To generate a new set of paragraphs, please click the Lorem Ipsum button above again. Give it a try!</p>
    <br>
    <div class="form">
        <form method="post">
